...
import seontalk.thread.ClientChatThread;
...
public class MainPage extends JFrame{
	...
	public ConnectionCtrl ctrl;
	public ClientThread cThread;
	public ObjectOutputStream oos;
	public ObjectInputStream ois;
	
	public ClientChatThread ccThread;
	...
	public MainPage(MemberVO pVO,Login login) {
		memVO = pVO;
		oos = login.oos;
		ois = login.ois;
		cThread = login.cThread;
		try {
			...
			ccThread = new ClientChatThread(this);
			ccThread.start();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public synchronized void send(SocketVO psVO) {
		try {
			oos.writeObject(psVO);
			wait();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void getChat() {
		SocketVO psVO = new SocketVO();
		psVO.setCommand("select");
		psVO.setWork("ChatList");
